        ...
        <div class="portal-container relative z-10 py-4 lg:py-6" x-data="{ sidebarOpen: false }">
            ...
            <div class="admin-shell">
                <aside class="admin-sidebar" :class="{ 'admin-sidebar-open': sidebarOpen }">
                    ...
                    <div class="mt-5 rounded-[20px] border border-slate-200 bg-slate-50 px-4 py-3">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-700/75">Workspace</p>
                        <p class="mt-2 text-sm leading-6 text-slate-600">Panel ini dipakai untuk operasi harian, monitoring, dan manajemen data inti.</p>
                    </div>
                ...
                <div class="admin-content">
                    <header class="admin-topbar">
                        ...
                        <div class="flex min-w-0 items-center gap-2">
                            <span class="max-w-[230px] truncate rounded-full border border-slate-200 bg-white px-3 py-1 text-sm text-slate-600 sm:max-w-none">

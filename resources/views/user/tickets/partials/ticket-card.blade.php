    ...
    <div class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_300px]">
        <div class="min-w-0">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="min-w-0">
                    <p class="portal-kicker">E-Ticket Archive</p>
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2">
                <div class="journey-manifest-card">
                    <p class="text-xs uppercase tracking-[0.18em] text-slate-500">Ticket Number</p>
        ...
        <div class="space-y-4">
            <div class="portal-surface-muted">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <p class="text-sm text-slate-500">Scan Access</p>
                        <p class="mt-1 font-semibold text-slate-800">Passenger QR</p>
                    </div>

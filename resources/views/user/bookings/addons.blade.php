    ...
    <section class="space-y-6" x-data="addonForm({{ Js::from($catalog) }})">
        <article class="portal-card">
            <div class="portal-section-head">
                <div class="min-w-0">
                    <p class="portal-kicker">Add-on desk</p>
        ...
        <div class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            <article class="portal-card">
                ...
                <h2 class="mt-2 font-heading text-3xl font-bold text-[#0f3f78]">Tambah Add-On</h2>
                <p class="portal-section-copy">Pilih add-on per passenger atau per booking. Harga otomatis masuk ke tagihan pending.</p>
            ...
            <aside class="portal-side-panel">
                ...
                <h2 class="mt-2 font-heading text-3xl font-bold text-[#0f3f78]">Current Invoice</h2>
        ...
        <article class="portal-card">
            ...
            <h2 class="mt-2 font-heading text-3xl font-bold text-[#0f3f78]">Daftar Add-On</h2>

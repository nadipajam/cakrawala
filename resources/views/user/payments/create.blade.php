    ...
    >
        <article class="portal-card">
            <div class="portal-section-head">
                <div>
                    <p class="portal-kicker">Payment desk</p>
                    <h1 class="portal-section-title">Complete your booking payment</h1>
                    <p class="portal-section-copy">Booking {{ $booking->booking_code }} ditahan selama 5 menit. Lengkapi pembayaran sebelum waktu habis agar kursi tidak dilepas kembali.</p>
                </div>
                <span class="portal-inline-note">Booking {{ ucfirst($booking->status) }}</span>
            </div>
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <div class="portal-metric-card">
                    ...
                    <p class="mt-3 text-lg font-semibold text-slate-800">{{ $booking->flight->departureAirport->code }} &rarr; {{ $booking->flight->arrivalAirport->code }}</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('payments.store') }}" enctype="multipart/form-data" class="mt-6 space-y-5">
                ...
                <div class="portal-surface-muted" x-show="selectedMethod" x-cloak>
        ...
        <aside class="portal-side-panel">
            <p class="portal-kicker">Live summary</p>
            <h2 class="mt-2 font-heading text-3xl font-bold text-[#0f3f78]">Booking Snapshot</h2>
            <div class="mt-5 space-y-3">
                ...
                <div class="portal-card-soft">
                    ...
                    <p class="font-semibold text-slate-800">{{ $booking->flight->departureAirport->code }} &rarr; {{ $booking->flight->arrivalAirport->code }}</p>
                </div>
                <div class="portal-card-soft">

...
@section('title', 'Cakrawala | QRIS Berhasil')
...
@section('content')
    <section class="mx-auto max-w-5xl space-y-6">
        <article class="payment-success-panel text-center">
            ...
            <p class="mt-5 booking-shell-kicker">Pembayaran berhasil</p>
            <h1 class="mt-2 font-heading text-4xl font-bold text-[#c2410c]">{{ $paymentLabel }}</h1>
            <p class="mt-3 text-lg text-slate-600">Pembayaran berhasil diproses otomatis dan booking siap dilanjutkan ke tahap berikutnya.</p>
        ...
        <article class="portal-card">
            ...
            <div class="mt-5 flex flex-wrap items-center gap-3">
                <a href="{{ route('my-bookings.show', $payment->booking) }}" class="portal-btn-gold">Buka Booking</a>

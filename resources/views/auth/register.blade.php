            ...
            <section class="portal-auth-split">
                <div class="auth-card max-w-[620px]">
                    <div class="mb-6 flex items-center justify-between gap-3">
                        ...
                        <a href="{{ route('login') }}" class="text-sm font-semibold text-slate-600 hover:text-orange-700">Masuk</a>
                    </div>

                    <div class="mb-8 text-center">
                        <p class="text-xs font-semibold uppercase tracking-[0.3em] text-orange-700/80">Daftar</p>
                        <h1 class="mt-3 font-heading text-5xl font-extrabold tracking-tight text-slate-900">Buat akun</h1>
                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <div class="auth-field">
                                    ...
                                    <input id="name" name="name" type="text" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Nama lengkap" class="auth-input">
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="phone" class="mb-2 block text-sm font-medium text-slate-700">Telepon</label>
                                <div class="auth-field">
                                    <span class="auth-field-icon">
                                    ...
                                    <input id="phone" name="phone" type="text" value="{{ old('phone') }}" autocomplete="tel" placeholder="Nomor telepon" class="auth-input">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="auth-field">
                                    ...
                                    <input id="password_confirmation" name="password_confirmation" :type="showConfirmPassword ? 'text' : 'password'" required autocomplete="new-password" placeholder="Konfirmasi password" class="auth-input">

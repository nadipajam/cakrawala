        ...
        <article class="admin-ops-detail-hero">
            ...
            <div class="mt-5 grid gap-4 xl:grid-cols-[1.35fr_.95fr]">
                <div class="admin-ops-inline-grid">
                    ...
                    <div class="admin-ops-info-card"><p class="admin-info-label">Code</p><p class="admin-info-value">{{ $airline->code }}</p></div>
                    <div class="admin-ops-info-card"><p class="admin-info-label">Name</p><p class="admin-info-value">{{ $airline->name }}</p></div>
                    <div class="admin-ops-info-card"><p class="admin-info-label">Total Bookings</p><p class="admin-info-value">{{ $bookingCount }}</p></div>
                </div>
